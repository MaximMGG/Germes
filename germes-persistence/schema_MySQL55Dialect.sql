...
create table ACCOUNT (ID integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, CREATED_BY integer, MODIFIED_BY integer, primary key (ID)) engine=InnoDB;
create table CITY (ID integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, DISTRINCT varchar(32) not null, NAME varchar(32) not null, REGION varchar(32) not null, CREATED_BY integer, MODIFIED_BY integer, primary key (ID)) engine=InnoDB;
create table STATION (ID integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, APARTMENT varchar(16), HOUSE_NO varchar(16), STREET varchar(32), ZIP_CODE varchar(10), X double precision, Y double precision, PHONE varchar(16), transportType integer, CREATED_BY integer, MODIFIED_BY integer, CITY_ID integer, primary key (ID)) engine=InnoDB;
